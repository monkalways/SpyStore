...
namespace SpyStore.Service.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        [HttpGet("{productId}")]
        public CartRecordWithProductInfo GetShoppingCartRecord(int customerId, int productId) => _repo.GetShoppingCartRecord(customerId, productId);

        [HttpGet(Name = "GetShoppingCart")]
        public IEnumerable<CartRecordWithProductInfo> GetShoppingCart(int customerId) => _repo.GetShoppingCartRecords(customerId);
        ...
        public IActionResult Delete(int customerId, int shoppingCartRecordId, string timeStamp)
        {
            ...
            _repo.Delete(shoppingCartRecordId, ts);
            return NoContent();
        }
